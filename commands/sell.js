...
module.exports.run = async (bot, message, args) => {
  ...
  if(!args[0] || isNaN(args[1])){
    ...
    .setColor(purple)
    .setTitle("Prices")
    .setDescription("**Use `sell <itemname> <amount> to sell desired item**")
  ...
  if(number > curfish) return message.reply("You don't have that many to sell.");
  ...
  if(args[0] === "ore"){
    ...
    if(number > curore) return message.reply("You don't have that many to sell.");
  ...
  if(args[0] === "wood"){
    ...
    if(number > curwood) return message.reply("You don't have that many to sell.");
  ...
  if(args[0] === "meat"){
    ...
    if(number > curmeat) return message.reply("You don't have that many to sell.");
